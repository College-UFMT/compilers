...
#line 36 "tab_simb.y"
                 {(yyval.int) = '\0';}
#line 1102 "tab_simb.tab.c"
    break;

  case 4: /* statement: expr  */
#line 39 "tab_simb.y"
                                  { printf("%d\n", (yyvsp[0].int)); }
#line 1108 "tab_simb.tab.c"
    break;

  case 5: /* statement: VARIABLE '=' expr  */
#line 40 "tab_simb.y"
                                  { table[count_table].val = (yyvsp[0].int);  
                                    strcpy(table[count_table].lex,(yyvsp[-2].st).lex);
                                    count_table++; }
#line 1116 "tab_simb.tab.c"
    break;

  case 6: /* expr: INTEGER  */
#line 45 "tab_simb.y"
                                  { (yyval.int) = (yyvsp[0].int);      }
#line 1122 "tab_simb.tab.c"
    break;

  case 7: /* expr: VARIABLE  */
#line 46 "tab_simb.y"
                                  { strcpy((yyval.int),(yyvsp[0].st).lex); }
#line 1128 "tab_simb.tab.c"
    break;

  case 8: /* expr: expr '+' expr  */
#line 47 "tab_simb.y"
                                  { (yyval.int) = (yyvsp[-2].int) + (yyvsp[0].int); }
#line 1134 "tab_simb.tab.c"
    break;

  case 9: /* expr: expr '-' expr  */
#line 48 "tab_simb.y"
                                  { (yyval.int) = (yyvsp[-2].int) - (yyvsp[0].int); }
#line 1140 "tab_simb.tab.c"
    break;

  case 10: /* expr: expr '*' expr  */
#line 49 "tab_simb.y"
                                  { (yyval.int) = (yyvsp[-2].int) * (yyvsp[0].int); }
#line 1146 "tab_simb.tab.c"
    break;

  case 11: /* expr: expr '/' expr  */
#line 50 "tab_simb.y"
                                  { (yyval.int) = (yyvsp[-2].int) / (yyvsp[0].int); }
#line 1152 "tab_simb.tab.c"
    break;

  case 12: /* expr: '(' expr ')'  */
#line 51 "tab_simb.y"
                                  { (yyval.int) = (yyvsp[-1].int); }
#line 1158 "tab_simb.tab.c"
    break;


#line 1162 "tab_simb.tab.c"
